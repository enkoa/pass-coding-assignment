...
// In avengers 4, the avengers will travel back in time, via the quantum realm, to 2012 or the event of the first
// avengers, they will go through the portal that the chitauri army is send through and fight thanos there
...
void dataManipulation(OULinkedList<NvraRecord>& linkedList, TemplatedArray<NvraRecord>* allArrays);
...
int main() {	
	...
	dataManipulation(*linkedList, allArrays);
